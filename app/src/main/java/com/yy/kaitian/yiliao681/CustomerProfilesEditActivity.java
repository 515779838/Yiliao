...
public class CustomerProfilesEditActivity extends Activity
{
  ...
  private static final String TAG = "CustomerProfilesEditActivity";
...
//    if (this.mbModify);
  ...
  private int addNewCustomerProfiles()
  {
    ...
    if (((RadioButton)findViewById(this.mRadioSexGroup.getCheckedRadioButtonId())).getText().equals("男")){
      this.mSex = "Male";
    } else {
      this.mSex = "Female";
    }
    if (((RadioButton)findViewById(this.mRadioMaritalStatusGroup.getCheckedRadioButtonId())).getText().equals("未婚")){
...
//    Log.e("CustomerProfilesEditActivity", "+++ ON CREATE +++");
    ...
    if (localBundle.getString("customer_profile_edit_type").equals("Modify"))
    {
      ...
      Log.e("CustomerProfilesEditActivity", "modify id=" + this.mId);
      localButton1.setText(R.string.modify);
      ...
      localButton1.setText(R.string.new_save);
      this.mbModify = false;
      ...
      Log.e("CustomerProfilesEditActivity", "new add");
  }
