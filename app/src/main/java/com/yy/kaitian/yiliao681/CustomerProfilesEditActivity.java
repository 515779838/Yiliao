    ...
    private void setListenter() {
        et_ChangeDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(CustomerProfilesEditActivity.this);
                builder.setMessage("请输入生日");
                builder.setCancelable(true);
                builder.setPositiveButton("确定", null);
                builder.setNegativeButton("取消", null);
                View dialog_view = View.inflate(CustomerProfilesEditActivity.this, R.layout.dialog_broth, null);

                final EditText et_year = (EditText) dialog_view.findViewById(R.id.et_year);
                final EditText et_month = (EditText) dialog_view.findViewById(R.id.et_month);
                final EditText et_date = (EditText) dialog_view.findViewById(R.id.et_date);
