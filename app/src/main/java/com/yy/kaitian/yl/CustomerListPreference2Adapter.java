...
public class CustomerListPreference2Adapter extends BaseAdapter {
    private final Context context;
    private final List<Map<String, String>> mapList;

    public CustomerListPreference2Adapter(Context paramContext, List<Map<String, String>> mapList) {
