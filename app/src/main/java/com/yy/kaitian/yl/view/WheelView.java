package com.yy.kaitian.yl.view;
...
/**
 * Created by caoyingfu on 2019/7/4.
 */
...
//            if (position == i) {
//                itemView.setTextColor(ContextCompat.getColor(context, R.color.textColor6));
//            } else {
//                itemView.setTextColor(ContextCompat.getColor(context, R.color.textColor2));
//            }
            if (position == i ) {
                itemView.setTextSize(TypedValue.COMPLEX_UNIT_SP, textSize);
                itemView.setTextColor(Color.parseColor("#4d4d4d"));
            } else if (position + 1 == i || position - 1 == i) {
                itemView.setTextColor(Color.parseColor("#9b96a3"));
            } else {
                itemView.setTextColor(Color.parseColor("#9b96a3"));
            }
        }
    ...
    // private int latSelectedIndex = -1;// 上次选择
    ...
    private void onSeletedCallBack() {
        if (null != onWheelViewListener) {
            // if (selectedIndex != latSelectedIndex) {
                onWheelViewListener.onSelected(selectedIndex, items.get(selectedIndex));
                //latSelectedIndex = selectedIndex;
            // }
        }
