...
public class DeviceListActivity extends Activity {
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> paramAnonymousAdapterView, View paramAnonymousView, int paramAnonymousInt, long paramAnonymousLong) {
            ...
            String str1 = "";
            try {
                str1 = ((TextView) paramAnonymousView).getText().toString();
            } catch (Exception e) {
                str1 = ((TextView) ((LinearLayout) paramAnonymousView).getChildAt(0)).getText().toString();
            }
            String str2 = null;
            try {
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        public void onReceive(Context paramAnonymousContext, Intent paramAnonymousIntent) {
            ...
            if (DeviceListActivity.this.mNewDevicesArrayAdapter.getCount() != 0) {
                ...
                ((TextView) findViewById(R.id.title_new_devices)).setText(str2);
            }
        }
    };
...
//    getWindow().setFeatureInt(7, R.layout.custom_title_button);
        ...
        this.mPairedDevicesArrayAdapter = new ArrayAdapter(this, R.layout.device_name, R.id.tv_info);
        this.mNewDevicesArrayAdapter = new ArrayAdapter(this, R.layout.device_name, R.id.tv_info);
